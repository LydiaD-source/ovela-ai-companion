...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    blurb:
      'Discover how your daily habits may be influencing long-term health and resilience.',
    bullets: [
      'Biological age estimate',
      'Recovery indicators',
      'Lifestyle optimisation opportunities',
      'Longevity recommendations',
      'Personalised improvement roadmap',
      'Downloadable PDF report',
    ],
    cta: 'Check My Biological Age',
    status: 'beta',
    initialPrompt:
    ...
    authority_topic: 'biological_age_assessment',
  },
  {
