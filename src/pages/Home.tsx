...
const Home = () => {
  ...
  const isabellaHeroHD = "https://res.cloudinary.com/di5gj4nyp/image/upload/w_1920,h_1080,c_fill,g_auto,f_auto,q_auto:best,dpr_auto/v1759836676/golddress_ibt1fp.png";
