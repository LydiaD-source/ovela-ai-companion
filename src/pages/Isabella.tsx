    ...
    <div className="pt-16">
      ...
      <Section className="text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Video Placeholder */}
          <div className="bg-gradient-to-br from-electric-blue/20 to-neon-purple/20 rounded-3xl p-12 glass mb-8">
            <div className="text-center">
              <div className="text-6xl mb-4">🎥</div>
              <p className="text-muted-foreground text-lg">
                [Isabella intro video via D_ID - Ready for integration]
              </p>
              <p className="text-sm text-muted-foreground/70 mt-4 italic">
                "Hello, my name is Isabella. I'm originally from Andorra la Vella, and I work as a model, promoter, and marketing specialist..."
              </p>
            </div>
          </div>
