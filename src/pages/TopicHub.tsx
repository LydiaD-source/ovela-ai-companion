...
const HUB_TOOLS: Record<string, ToolKind[]> = {
  ...
  'ai-clinic-receptionist':             ['receptionist_cost', 'missed_leads', 'wellness_assessment', 'nutrition_assessment', 'biological_age'],
  ...
  'ai-for-wellness-clinics':            ['wellness_assessment', 'nutrition_assessment', 'biological_age', 'receptionist_cost'],
  'executive-burnout-recovery':         ['wellness_assessment', 'biological_age'],
  'executive-wellness-programs':        ['wellness_assessment', 'biological_age', 'nutrition_assessment'],
