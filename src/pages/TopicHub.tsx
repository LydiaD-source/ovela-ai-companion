...
const HUB_TOOLS: Record<string, ToolKind[]> = {
  ...
  'ai-clinic-receptionist':             ['receptionist_cost', 'missed_leads', 'wellness_assessment', 'nutrition_assessment', 'recovery_resilience'],
  ...
  'ai-for-wellness-clinics':            ['wellness_assessment', 'nutrition_assessment', 'recovery_resilience', 'receptionist_cost'],
  'executive-burnout-recovery':         ['wellness_assessment', 'recovery_resilience'],
  'executive-wellness-programs':        ['wellness_assessment', 'recovery_resilience', 'nutrition_assessment'],
